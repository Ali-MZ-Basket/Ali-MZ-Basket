...
[assembly: System.Runtime.CompilerServices.InternalsVisibleToAttribute("Accounting.Components.Domain.Test")]
namespace Accounting.Components.Domain.Client
{
    /// <summary>
    ...
    internal class CustomJsonCodec : RestSharp.Serializers.ISerializer, RestSharp.Deserializers.IDeserializer
    {
        ...
        public string Serialize(object obj)
        {
            ...
            if (obj.GetType().FullName.Contains(@"Accounting.Components.Domain.Model.Accounting") || obj.GetType().FullName.Contains(@"Accounting.Components.Domain.Model.PayrollAu") )
            {
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        public ApiClient()
        {
            _baseUrl = Accounting.Components.Domain.Client.GlobalConfiguration.Instance.BasePath;
        }
